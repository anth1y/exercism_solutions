...
def get_rounds(number):
    ...
    """
    return [number + _ for _ in range(3)]
...
def approx_average_is_average(hand):
    ...
    return true_avg in (first_last_avg, mid_card)
...
def average_even_is_average_odd(hand):
    ...
    """
    even_values = [hand[value]for value in range(len(hand)) if value % 2 == 0]
    odd_values = [hand[value] for value in range(len(hand)) if value % 2 ==1]
