...
def get_change(budget, exchanging_value):
    ...
    remaining_funds = budget - exchanging_value
...
def get_leftover_of_bills(amount, denomination):
    ...
    leftover = amount % float(denomination)
    return leftover
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    exchanged_currency = budget/new_exchange_rate

    return (exchanged_currency//denomination)*denomination
